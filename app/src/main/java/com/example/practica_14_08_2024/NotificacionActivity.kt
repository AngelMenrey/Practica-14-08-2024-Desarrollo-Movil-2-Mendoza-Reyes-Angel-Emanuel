...
class NotificacionActivity : AppCompatActivity() {
    ...
    fun calcularIMC(view: View){
        ...
        var est : Float
        var pes : Float
        if (peso.text.isNotEmpty() && peso.text.isNotBlank() && estatura.text.isNotEmpty() && estatura.text.isNotBlank()){
            ...
            if(imc > 25.0f){
                Toast.makeText(applicationContext, "IMC $imc, sobrepeso", Toast.LENGTH_LONG).show()
    ...
    private fun buildNotification(){
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText("Visita a tu nutriologo para una mejor alimentacion")
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            //.setContentIntent(pendingIntent)
            .addAction(R.drawable.baseline_notifications_active_24, "Aceptar", pendingIntentSi)
            .addAction(R.drawable.baseline_notifications_active_24, "Cancelar", pendingIntentNo)
            .setAutoCancel(true)
